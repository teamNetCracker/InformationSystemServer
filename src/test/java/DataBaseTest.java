...
public class DataBaseTest
{
    ...
    public void checkGetGenre()
    {
        ...
        MatcherAssert.assertThat(genreDataObject, is(MatcherGTOwithGenreEntity.matcher(genre)));
    }
    @Test
    public void checkGetTrack()
    {
        ...
        MatcherAssert.assertThat(trackDataObject, is(MatcherDTOwithTrackEntity.matcher(trackEntity)));
    ...
    public void checkSearchTrack()
    {
        ...
        MatcherAssert.assertThat(trackDataObjectList.get(0), is(MatcherDTOwithTrackEntity.matcher(trackEntity1)));
        MatcherAssert.assertThat(trackDataObjectList.get(1), is(MatcherDTOwithTrackEntity.matcher(trackEntity2)));
    }
    @Test
    public void checkSearchGenre()
    {
        ...
        MatcherAssert.assertThat(genreDataObject, is(MatcherGTOwithGenreEntity.matcher(genreEntity)));
    }
    @Test
    public void checkSearchTrackByGenre()
    {
        ...
        MatcherAssert.assertThat(trackDataObjectList.get(0), is(MatcherDTOwithTrackEntity.matcher(track1)));
    }
    @Test
    ...
    public void checkAddGenre()
    {
        ...
        MatcherAssert.assertThat(genreEntity, is(MatcherGenreEntityWithGTO.matcher(genreDataObject)));
    }
    @Test
    ...
    public void checkGetAllGenres()
    {
        ...
        MatcherAssert.assertThat(genreDataObjects.get(0), is(MatcherGTOwithGenreEntity.matcher(genreEntity1)));
        MatcherAssert.assertThat(genreDataObjects.get(1), is(MatcherGTOwithGenreEntity.matcher(genreEntity2)));
    }
    @Test
    public void checkUpdateTrack()
    {
        ...
        MatcherAssert.assertThat(trackEntity, is(MatcherTrackEntityWithDTO.matcher(trackDataObject)));
    }
    @Test
